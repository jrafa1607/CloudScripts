...
do
        ...
        do
                ...
                cmd=$(aws ec2 describe-instances --query 'Reservations[].Instances[].[InstanceId,Name,AvailabilityZone,PrivateDnsName,PrivateIpAddress,PublicDnsName,PublicIpAddress,State.Name]' --output text --region $regiao --profile $conta)
